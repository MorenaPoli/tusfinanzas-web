...
export default function LandingPage() {
  ...
  const testimonials = [
    ...
    },
    {
      ...
      text: 'Probe YNAB y era demasiado complejo. TusFinanzas es directo: cargo mis gastos, veo mis graficos y el experto me dice que hacer. Por $4.99 esta regalado.',
      stars: 5,
    },
    {
      name: 'Lucia M.',
  ...
  const faqs = [
    { q: 'Cuanto cuesta TusFinanzas?', a: 'Es gratis para empezar. El plan Pro cuesta $4.99 al mes o $39.99 al ano (33% de descuento). El plan Familiar es $8.99/mes o $69.99/ano.' },
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }}
                ...
                TusFinanzas te ayuda a gestionar ingresos, gastos, inversiones y deudas.
              ...
              <div className="relative w-[300px] h-[600px] bg-[#111] rounded-[40px] border border-white/10 p-3 shadow-2xl shadow-[#FF2D92]/10">
                <div className="w-full h-full bg-[#0A0A0A] rounded-[32px] overflow-hidden p-5">
                  <div className="flex items-center justify-between mb-4">
                    <span className="font-bold text-sm">TusFinanzas</span>
        ...
        <div className="max-w-3xl mx-auto px-6">
          <Reveal>
            <div className="text-center mb-12">
              ...
              <h2 className="text-3xl lg:text-4xl font-extrabold tracking-tight mt-3 mb-4">
                Por que elegir <span className="bg-gradient-to-r from-[#FF2D92] to-[#8B5CF6] bg-clip-text text-transparent">TusFinanzas</span>
              </h2>
            </div>
          </Reveal>
          ...
          <Reveal delay={0.1}>
            <div className="rounded-2xl bg-[#111] border border-white/[0.06] overflow-hidden">
              <div className="grid grid-cols-4 gap-0 text-center">
                ...
                <div className="p-4 text-[10px] text-[#FF2D92] uppercase tracking-wider font-bold border-b border-white/[0.06] bg-[#FF2D92]/5">TusFinanzas</div>
      ...
      <footer className="border-t border-white/[0.06] py-12">
        <div className="max-w-6xl mx-auto px-6">
          <div className="grid md:grid-cols-4 gap-8 mb-8">
            <div>
              <div className="flex items-center gap-2 mb-3">
                <img src="/logo.jpg" alt="TusFinanzas" className="w-7 h-7 rounded-lg object-cover" />
                <span className="font-bold text-sm">TusFinanzas</span>
              </div>
          ...
          <div className="border-t border-white/[0.06] pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-[10px] text-white/20"> 2025 TusFinanzas. Todos los derechos reservados.</p>
